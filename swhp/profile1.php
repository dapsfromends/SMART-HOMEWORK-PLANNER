...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="showcase">
          <div class="left_side_content">
            ...
            <p>
              Your Smart HomeWork Planner helps to not just organize but also
              prioritize your tasks, set deadlines and set and meet targets,
    ...
    <script>
      ...
      function auth4() {
        window.location.assign("rem.html");
        return;
      }
    </script>
  </body>
